(function () {
    ...
    function () {
        ...
        var a = this,
                    ...
                    if ("contextmenu" == g && s) l(d, g, h, i);
                        ...
                        if (null == d.__taTapHandler) {
                            var j = d.__taTapHandler = {
                                ...
                                k = function (e) {
                                    for (var f = e.srcElement || e.target, g = 0; g < j.downSelectors.length; g++)
                                        if (null == j.downSelectors[g] || c(f, j.downSelectors[g], d)) {
                                    ...
                                    if (j.down) {
                                        ...
                                        for (var g in n)
                                            if (n.hasOwnProperty(g)) {
                                                var h = n[g];
                                                if (h.touches === f && (1 === h.taps || h.taps === j.taps))
                                                    for (var i = 0; i < j[g].length; i++)(null == j[g][i][1] || c(b, j[g][i][1], d)) && j[g][i][0].apply(e(a), [a])
                                            }
                                    }
                                },
                                o = function () {
            ...
            s = "onmousedown" in document.documentElement,
            t = {
            ...
            D = function (a, b, c, d) {
                if (h(a, b, c), d.__tauid = c.__tauid, a.addEventListener) a.addEventListener(b, c, !1);
            ...
            E = function (a, b, c) {
                null != c && F(a, function () {
                    var e = d(this);
                    if (i(e, b, c), null != c.__tauid)
                        if (e.removeEventListener) e.removeEventListener(b, c, !1), r && t[b] && e.removeEventListener(t[b], c, !1);
        ...
        a.Mottle = function (a) {
            a = a || {};
            var c = a.clickThreshold || 150,
                e = a.dblClickThreshold || 350,
                f = new q,
                g = new o(c, e),
                h = a.smartClicks,
                i = function (a, b, c, e) {
            ...
            this.remove = function (a) {
                    ...
                    if (a.__ta)
                        for (var b in a.__ta)
                            if (a.__ta.hasOwnProperty(b))
                                for (var c in a.__ta[b]) a.__ta[b].hasOwnProperty(c) && E(a, b, a.__ta[b][c]);
                ...
                var g = s && ("undefined" == typeof MouseEvent || null == e || e.constructor === MouseEvent),
                    h = r && !s && t[c] ? t[c] : c,
                    i = !(r && !s && t[c]),
                    j = x(e),
                    k = y(e),
    ...
    function () {
        ...
        var a = function (a, b, c) {
            ...
            k = 9 == g,
            l = function (a) {
                if (j) return [a.clientX + document.documentElement.scrollLeft, a.clientY + document.documentElement.scrollTop];
                var b = n(a),
                    c = m(b, 0);
                return k ? [c.pageX || c.clientX, c.pageY || c.clientY] : [c.pageX, c.pageY]
            },
            m = function (a, b) {
                return a.item ? a.item(b) : a[b]
            },
            ...
            p = "katavorio-drag-scope",
            q = ["stop", "start", "drag", "drop", "over", "out", "beforeStart"],
            r = function () {},
            s = function () {
                return !0
            },
            ...
            v = function (a, b) {
                if (null != a) {
                    a = d(a) || null != a.tagName || null == a.length ? [a] : a;
            ...
            x = "input,textarea,select,button,option",
            y = function (a, b, c) {
                var d = a.srcElement || a.target;
                return !f(d, c.getInputFilterSelector(), b)
            },
            z = function (a, b, c, d) {
                this.params = b || {}, this.el = a, this.params.addClass(this.el, this._class), this.uuid = C();
                var e = !0;
                return this.setEnabled = function (a) {
                    ...
                    var b = {};
                    v(this.scopes, function (a) {
                        b[a] = !0
                    }), v(a ? a.split(/\s+/) : [], function (a) {
                        b[a] = !0
                    }), this.scopes = [];
            ...
            A = function (a, b, c) {
                ...
                var g = z.apply(this, arguments);
                this.rightButtonCanDrag = this.params.rightButtonCanDrag;
                var j = [0, 0],
                    k = null,
                    m = !1,
                    n = this.params.consumeStartEvent !== !1,
                    o = this.el,
                    p = this.params.clone,
                    q = (this.params.scroll, b.multipleDrop !== !1),
                    r = b.snapThreshold || 5,
                ...
                this.posses = [], this.posseRoles = {}, this.toGrid = function (a) {
                    return null == this.params.grid ? a : t(a, this.params.grid[0], this.params.grid[1])
                }, this.snap = function (a, b) {
                    if (null != o) {
                        a = a || (this.params.grid ? this.params.grid[0] : h), b = b || (this.params.grid ? this.params.grid[1] : i);
                        var c = this.params.getPosition(o);
                        this.params.setPosition(o, t(c, a, b, a, b))
                    }
                ...
                var v = function (a) {
                        return "function" == typeof a ? (a._katavorioId = C(), a._katavorioId) : a
                    },
                    x = {},
                    A = function (a) {
                        for (var b in x) {
                    ...
                    B = this.setFilter = function (b, c) {
                        if (b) {
                            var e = v(b);
                            x[e] = [function (c) {
                                var e, g = c.srcElement || c.target;
                                return d(b) ? e = f(g, b, a) : "function" == typeof b && (e = b(c, a)), e
                            }, c !== !1]
                        }
                    };
                this.addFilter = B, this.removeFilter = function (a) {
                    var b = "function" == typeof a ? a._katavorioId : a;
                    delete x[b]
                }, this.clearAllFilters = function () {
                    x = {}
                }, this.canDrag = this.params.canDrag || s;
                var D, E = [],
                    F = [];
                this.downListener = function (a) {
                    var b = this.rightButtonCanDrag || 3 !== a.which && 2 !== a.button;
                    if (b && this.isEnabled() && this.canDrag()) {
                        var d = A(a) && y(a, this.el, this.k);
                        if (d) {
                            if (p) {
                                o = this.el.cloneNode(!0), o.setAttribute("id", null), o.style.position = "absolute";
                                var f = e(this.el);
                                o.style.left = f.left + "px", o.style.top = f.top + "px", document.body.appendChild(o)
                            } else o = this.el;
                            n && w(a), j = l(a), this.params.bind(document, "mousemove", this.moveListener), this.params.bind(document, "mouseup", this.upListener), g.markSelection(this), g.markPosses(this), this.params.addClass(document.body, c.noSelect), H("beforeStart", {
                                el: this.el,
                                pos: k,
                                e: a,
                                drag: this
                            })
                        } else this.params.consumeFilteredEvents && w(a)
                    }
                    ...
                    if (j) {
                        ...
                        if (j) {
                            ...
                            d /= f, e /= f, this.moveBy(d, e, a), g.updateSelection(d, e, this), g.updatePosses(d, e, this)
                        }
                    }
                }.bind(this), this.upListener = function (a) {
                    j && (j = null, this.params.unbind(document, "mousemove", this.moveListener), this.params.unbind(document, "mouseup", this.upListener), this.params.removeClass(document.body, c.noSelect), this.unmark(a), g.unmarkSelection(this, a), g.unmarkPosses(this, a), this.stop(a), g.notifySelectionDragStop(this, a), g.notifyPosseDragStop(this, a), m = !1, p && (o && o.parentNode && o.parentNode.removeChild(o), o = null))
                ...
                b.events.start && G.start.push(b.events.start), b.events.beforeStart && G.beforeStart.push(b.events.beforeStart), b.events.stop && G.stop.push(b.events.stop), b.events.drag && G.drag.push(b.events.drag), this.on = function (a, b) {
                    G[a] && G[a].push(b)
                };
                var H = function (a, b) {
                    if (G[a])
                        for (var c = 0; c < G[a].length; c++) try {
                            G[a][c](b)
                        } catch (d) {}
                };
                this.notifyStart = function (a) {
                    ...
                    if (b || m) {
                        ...
                        if (d.length > 1)
                            for (var f = 0; f < d.length; f++) {
                                var h = this.params.getPosition(d[f].el);
                                c.push([d[f].el, {
                                    left: h[0],
                                    top: h[1]
                                }, d[f]])
                    ...
                    if (k = this.params.getPosition(o), this.size = this.params.getSize(o), E = g.getMatchingDroppables(this), u(E, !0, !1, this), this.params.addClass(o, this.params.dragClass || c.drag), this.params.constrain || this.params.containment) {
                    ...
                    a && g.notifySelectionDragStart(this)
                }, this.unmark = function (a, b) {
                    if (u(E, !1, !0, this), this.params.removeClass(o, this.params.dragClass || c.drag), E.length = 0, !b)
                        for (var d = 0; d < F.length; d++) {
                            var e = F[d].drop(this, a);
                            if (e === !0) break
                        }
                    ...
                    for (var g = 0; g < E.length; g++) {
                        ...
                        this.params.intersects(e, h) && (q || null == f || f == E[g].el) && E[g].canDrop(this) ? (f || (f = E[g].el), F.push(E[g]), E[g].setHover(this, !0, c)) : E[g].isHover() && E[g].setHover(this, !1, c)
                    }
                    H("drag", {
                        el: this.el,
                        pos: d,
            ...
            B = function (a, b, c) {
                this._class = c.droppable, this.params = b || {}, this._activeClass = this.params.activeClass || c.active, this._hoverClass = this.params.hoverClass || c.hover, z.apply(this, arguments);
                var d = !1;
            ...
            D = function (a) {
                return null == a ? null : (a = "string" == typeof a || a.constructor == String ? document.getElementById(a) : a, null == a ? null : (a._katavorio = a._katavorio || C(), a))
            };
        this.Katavorio = function (e) {
            ...
            var h = 1,
                ...
                j = function (a, b) {
                    ...
                    return v(a, function (a) {
                        for (var d = 0; d < a.scopes.length; d++)
                            if (b[a.scopes[d]]) {
                                var f = e.indexOf(b[a.scopes[d]], a); - 1 != f && (b[a.scopes[d]].splice(f, 1), c++)
                            }
                    }), c > 0
                },
                k = (this.getMatchingDroppables = function (a) {
                    ...
                    for (b in e) c[b] = e[b];
                    for (b in a) c[b] = a[b];
                    for (b = 0; b < q.length; b++) c.events[q[b]] = a[q[b]] || r;
                    return c.katavorio = this, c
                }.bind(this)),
                l = function (a, b) {
                    for (var c = 0; c < q.length; c++) b[q[c]] && a.on(q[c], b[q[c]])
                }.bind(this),
                m = {},
                n = e.css || {},
                s = e.scope || p;
            for (var u in o) m[u] = o[u];
            for (var u in n) m[u] = n[u];
            var w = e.inputFilterSelector || x;
            this.getInputFilterSelector = function () {
                ...
                return v(a, function (a) {
                    if (a = D(a), null != a)
                        if (null == a._katavorioDrag) {
                            var d = k(b);
                            a._katavorioDrag = new A(a, d, m, s), i(a._katavorioDrag, this._dragsByScope), c.push(a._katavorioDrag), e.addClass(a, m.draggable)
                        } else l(a._katavorioDrag, b)
                }.bind(this)), c
            }, this.droppable = function (a, b) {
                var c = [];
                return v(a, function (a) {
                    if (a = D(a), null != a) {
                        var d = new B(a, k(b), m, s);
                        a._katavorioDrop = a._katavorioDrop || [], a._katavorioDrop.push(d), i(d, this._dropsByScope), c.push(d), e.addClass(a, m.droppable)
                    }
                }.bind(this)), c
            }, this.select = function (a) {
                return v(a, function () {
                    var a = D(this);
                    a && a._katavorioDrag && (g[a._katavorio] || (f.push(a._katavorioDrag), g[a._katavorio] = [a, f.length - 1], e.addClass(a, m.selected)))
                }), this
            }, this.deselect = function (a) {
                return v(a, function () {
                    var a = D(this);
                    if (a && a._katavorio) {
                        var b = g[a._katavorio];
                        if (b) {
                            for (var c = [], d = 0; d < f.length; d++) f[d].el !== a && c.push(f[d]);
                            f = c, delete g[a._katavorio], e.removeClass(a, m.selected)
                        }
                    }
                }), this
                ...
                a.posses && v(a.posses, function (b) {
                    a.posseRoles[b] && E[b] && t(E[b].members, function (a) {
                        a.mark()
                    }, a)
                })
                ...
                a.posses && v(a.posses, function (c) {
                    a.posseRoles[c] && E[c] && t(E[c].members, function (a) {
                        a.unmark(b, !0)
                    }, a)
                })
            ...
            var y = function (a, b) {
                b.posses && v(b.posses, function (c) {
                    b.posseRoles[c] && E[c] && t(E[c].members, function (b) {
                        a(b)
                    }, b)
                })
            };
            ...
            v(["set", "add", "remove", "toggle"], function (a) {
                this[a + "Scope"] = function (b, c) {
                    ...
                    z(b.constructor === A ? b : b._katavorioDrag, c, this._dragsByScope, a + "Scope")
                }.bind(this), this[a + "DropScope"] = function (b, c) {
                    z(b.constructor === B ? b : b._katavorioDrop, c, this._dropsByScope, a + "Scope")
                }.bind(this)
            }.bind(this)), this.snapToGrid = function (a, b) {
                for (var c in this._dragsByScope) t(this._dragsByScope[c], function (c) {
                    c.snap(a, b)
                })
            ...
            var C = function (a, b, c) {
                a = D(a), a[b] && (j(a[b], c) && v(a[b], function (a) {
                    a.destroy()
                }), a[b] = null)
            };
            this.elementRemoved = function (a) {
                ...
                C(a, "_katavorioDrag", this._dragsByScope)
            }, this.destroyDroppable = function (a) {
                C(a, "_katavorioDrop", this._dropsByScope)
            }, this.reset = function () {
                this._dragsByScope = {}, this._dropsByScope = {}, f = [], g = {}, E = {}
            };
            var E = {},
                F = function (b, c, e) {
                    var f = d(c) ? c : c.id,
                    ...
                    return v(b, function (b) {
                        if (b._katavorioDrag) {
                            if (e && null != b._katavorioDrag.posseRoles[h.name]) return;
                            a(h.members, b._katavorioDrag), a(b._katavorioDrag.posses, h.name), b._katavorioDrag.posseRoles[h.name] = g
                        }
                    }), h
                };
            this.addToPosse = function (a) {
                for (var b = [], c = 1; c < arguments.length; c++) b.push(F(a, arguments[c]));
                return 1 == b.length ? b[0] : b
            }, this.setPosse = function (a) {
                for (var b = [], d = 1; d < arguments.length; d++) b.push(F(a, arguments[d], !0).name);
                return v(a, function (a) {
                    if (a._katavorioDrag) {
                        var d = c(a._katavorioDrag.posses, b),
                            e = [];
                        Array.prototype.push.apply(e, a._katavorioDrag.posses);
                        for (var f = 0; f < d.length; f++) this.removeFromPosse(a, d[f])
                    }
                }.bind(this)), 1 == b.length ? b[0] : b
            }, this.removeFromPosse = function (a, c) {
                if (arguments.length < 2) throw new TypeError("No posse id provided for remove operation");
                for (var d = 1; d < arguments.length; d++) c = arguments[d], v(a, function (a) {
                    if (a._katavorioDrag && a._katavorioDrag.posses) {
                        var d = a._katavorioDrag;
                        v(c, function (a) {
                            b(E[a].members, d), b(d.posses, a), delete d.posseRoles[a]
                        })
                    }
                })
                ...
                v(a, function (a) {
                    if (a._katavorioDrag && a._katavorioDrag.posses) {
                        ...
                        v(c.posses, function (a) {
                            b(E[a].members, c)
                        }), c.posses.length = 0, c.posseRoles = {}
                    }
                })
    ...
    function () {
        ...
        var o = 0,
            ...
            q = window.jsPlumbInstance = function (b) {
                ...
                }, b && r.extend(this.Defaults, b), this.logEnabled = this.Defaults.LogEnabled, this._connectionTypes = {}, this._endpointTypes = {}, d.EventGenerator.apply(this);
                var f = this,
                    h = p(),
                    i = f.bind,
                    j = {},
                ...
                this.unbindContainer = function () {
                    if (null != q && s.length > 0)
                        for (var a = 0; a < s.length; a++) f.off(q, s[a][0], s[a][1])
                ...
                var t = null,
                    ...
                    M = function (a, b, c, e) {
                        if (!r.headless) {
                            ...
                            if (g && r.isDragSupported(a, f)) {
                                ...
                                if (h = r.extend({}, h), r.isAlreadyDraggable(a, f)) c.force && f.initDraggable(a, h);
                                else {
                                    var i = r.dragEvents.drag,
                                        j = r.dragEvents.stop,
                                        k = r.dragEvents.start,
                                        l = f.getElement(a),
                                    ...
                                    pb(e, a), h[k] = d.wrap(h[k], function () {
                                        ...
                                        for (var a = arguments[0].selection, b = f.getUIPosition(arguments), c = function (a) {
                                                K(a[0], b), f.removeClass(a[0], "jsplumb-dragged"), f.select({
                                                    source: a[0]
                    ...
                    R = function (a, b) {
                        var c = f.Defaults.EndpointType || r.Endpoint,
                            d = r.extend({}, a);
                    ...
                    Y = function (a, b, c) {
                        ...
                        return e && "undefined" !== e || (2 == arguments.length && void 0 !== arguments[1] ? e = b : (1 == arguments.length || 3 == arguments.length && !arguments[2]) && (e = "jsPlumb_" + h + "_" + I()), c || f.setAttribute(a, "id", e)), e
                    };
                ...
                var Z = [{
                    ...
                    $ = function (a, b, c, d) {
                        ...
                        if (b.constructor == r.Endpoint) e = b, e.addConnection(a);
                ...
                this.unregisterEndpoint = function (a) {
                    ...
                    if (0 !== arguments.length) {
                        var a = f.Defaults.ConnectionType || f.getDefaultConnectionType(),
                            ...
                            e = c.fireEvent !== !1,
                            g = c.forceDetach,
                            h = b ? arguments[0] : c.connection;
                        if (h)(g || d.functionChain(!0, !1, [
                            [h.endpoints[0], "isDetachAllowed", [h]],
                            [h.endpoints[1], "isDetachAllowed", [h]],
                            [h, "isDetachAllowed", [h]],
                            [f, "checkCondition", ["beforeDetach", h]]
                        ])) && h.endpoints[0].detach(h, !1, !0, e);
                        else {
                            var i = r.extend({}, c);
                            if (i.uuids) L(i.uuids[0]).detachFrom(L(i.uuids[1]), e);
                            else if (i.sourceEndpoint && i.targetEndpoint) i.sourceEndpoint.detachFrom(i.targetEndpoint);
                            else {
                                var j = Y(f.getElement(i.source)),
                                    k = Y(f.getElement(i.target));
                                S(j, function (a) {
                                    (a.sourceId == j && a.targetId == k || a.targetId == j && a.sourceId == k) && f.checkCondition("beforeDetach", a) && a.endpoints[0].detach(a, !1, !0, e)
                                })
                            }
                        }
                    }
                    ...
                    var b = {
                        ...
                        e = function (d) {
                            if (null != d && null == b.connections[d.id] && (a.dontUpdateHover || null == d._jsPlumb || d.setHover(!1), b.connections[d.id] = d, b.connectionCount++, c))
                                for (var e = 0; e < d.endpoints.length; e++) d.endpoints[e]._deleteOnDetach && g(d.endpoints[e])
                        },
                        g = function (d) {
                    ...
                    for (var h in b.connections) {
                        ...
                        i._jsPlumb && (d.removeWithFunction(v, function (a) {
                            return i.id == a.id
                        }), _(i, a.fireEvent === !1 ? !1 : !i.pending, a.originalEvent), i.endpoints[0].detachFromConnection(i), i.endpoints[1].detachFromConnection(i), i.cleanup(!0), i.destroy(!0))
                    }
                ...
                var bb = function (a, b, c, d) {
                    ...
                    fb = function (a, b) {
                        ...
                        if (a)
                            ...
                            for (var d = 0, e = a.length; e > d; d++) c.push(n(a[d]).id);
                        else c.push(n(a).id);
                        return c
                    },
                    gb = function (a, b, c) {
                ...
                this.init = function () {
                    ...
                    var b = function (a, b, c) {
                        ...
                        }, d.extend(r.Connectors[a][b], [c, r.ConnectorRenderers[a]])
                    };
                    if (!r.connectorsInitialized) {
                        for (var e = 0; e < c.length; e++)
                            for (var g = 0; g < a.length; g++) b(a[g], c[e][1], c[e][0]);
                        r.connectorsInitialized = !0
                    }
                    u || (ob(), f.anchorManager = new r.AnchorManager({
                        jsPlumbInstance: f
                    }), u = !0, f.fire("ready", f))
                    ...
                    if ("string" == typeof c) g = b(arguments[0], {
                        ...
                        if (d.isArray(c[0]) || d.isString(c[0])) 2 == c.length && d.isObject(c[1]) ? d.isString(c[0]) ? (a = r.extend({
                            elementId: e,
                            jsPlumbInstance: f
                            ...
                            i = b._jsPlumb.EndpointDropHandler({
                                ...
                                getEndpoint: function (c) {
                                    ...
                                    if (null == d || null == d._jsPlumb) {
                                        var e = f.deriveEndpointAndAnchorSpec(c.getType().join(" "), !0),
                                            g = e.endpoints ? r.extend(b, {
                                                endpoint: a.def.def.endpoint || e.endpoints[1]
                                            }) : b;
                                        e.anchors && (g = r.extend(g, {
                                            anchor: a.def.def.anchor || e.anchors[1]
                                        })), d = f.addEndpoint(a.el, g), d._mtNew = !0
                                    }
                                    if (b.uniqueEndpoint && (a.def.endpoint = d), d._doNotDeleteOnDetach = !1, d._deleteOnDetach = !0, c.isDetachable() && d.initDraggable(), null != d.anchor.positionFinder) {
                                        var h = f.getUIPosition(arguments, f.getZoom()),
                                            i = f.getOffset(a.el),
                                            j = f.getSize(a.el),
                                            k = d.anchor.positionFinder(h, i, j, d.anchor.constructorParams);
                ...
                this.makeTarget = function (a, b, c) {
                    ...
                    for (var e = (!(d.deleteEndpointsOnDetach === !1), d.maxConnections || -1), f = function (a) {
                            ...
                            b.def = h, this.targetEndpointDefinitions[c][g] = h, tb(b, d, f, d.isSource === !0, !0), b.el._katavorioDrop[b.el._katavorioDrop.length - 1].targetDef = h
                    ...
                    r.extend(e, b);
                    var g = e.connectionType || "default",
                        h = f.deriveEndpointAndAnchorSpec(g);
                    ...
                    for (var i = e.maxConnections || -1, j = e.onMaxConnections, k = function (a) {
                            ...
                            var k = r.dragEvents.stop,
                                m = r.dragEvents.drag,
                                n = r.extend({}, e.dragOptions || {}),
                                o = n.drag,
                                p = n.stop,
                                q = null,
                                s = !1;
                            ...
                            var t = function (h) {
                                if (3 !== h.which && 2 !== h.button) {
                                    var k = this.sourceEndpointDefinitions[b][g];
                                    if (k.enabled) {
                                        if (b = this.getId(this.getElement(a.el)), e.filter) {
                                            var m = d.isString(e.filter) ? sb(h, a.el, e.filter, this, e.filterExclude) : e.filter(h, a.el);
                                            if (m === !1) return
                                        }
                                        var o = this.select({
                                            source: b
                                        }).length;
                                        if (k.maxConnections >= 0 && o >= k.maxConnections) return j && j({
                                            element: a.el,
                                            maxConnections: i
                                        }, h), !1;
                                        var p = r.getPositionOnElement(h, c, l),
                                            t = {};
                                        r.extend(t, e), t.isTemporarySource = !0, t.anchor = [p[0], p[1], 0, 0], t.dragOptions = n, k.def.scope && (t.scope = k.def.scope), q = this.addEndpoint(b, t), s = !0, q._doNotDeleteOnDetach = !1, q._deleteOnDetach = !0, k.uniqueEndpoint && (k.endpoint ? q.finalEndpoint = k.endpoint : (k.endpoint = q, q._deleteOnDetach = !1, q._doNotDeleteOnDetach = !0));
                                        var u = function () {
                                            f.off(q.canvas, "mouseup", u), f.off(a.el, "mouseup", u), s && (s = !1, f.deleteEndpoint(q))
                                        };
                                        f.on(q.canvas, "mouseup", u), f.on(a.el, "mouseup", u);
                                        var v = {};
                                        if (k.def.extract)
                                            for (var w in k.def.extract) {
                                                var x = h.srcElement.getAttribute(w);
                                                x && (v[k.def.extract[w]] = x)
                                            }
                                        f.trigger(q.canvas, "mousedown", h, v), d.consume(h)
                                    }
                                }
                            }.bind(this);
                            this.on(a.el, "mousedown", t), h.trigger = t, e.filter && (d.isString(e.filter) || d.isFunction(e.filter)) && f.setDragFilter(a.el, e.filter);
                    ...
                    var d = n(a),
                        e = this.sourceEndpointDefinitions[d.id];
                    if (e)
                        for (var g in e)
                            if (null == b || b === g) {
                                var h = e[g].trigger;
                ...
                var wb = function (a, b, c, e, f) {
                        ...
                        if (f = f || "default", d.isString(b) && g[b] && g[b][f]) g[b][f].enabled = e ? !g[b][f].enabled : c;
                        else if (b.length)
                ...
                this.repaint = function (a, b, c) {
                    ...
                    var d = function (a) {
                        ...
                        if (delete w[h.id], b && h.el && 3 != h.el.nodeType && 8 != h.el.nodeType)
                ...
                this.clear = function () {
                    ...
                    b = "" + b, c ? a = this.getElement(b) : (a = this.getElement(e), this.setAttribute(a, "id", b)), w[b] = w[e] || [];
                    for (var h = 0, i = w[b].length; i > h; h++) w[b][h].setElementId(b), w[b][h].setReferenceElement(a);
                    delete w[e], this.sourceEndpointDefinitions[b] = this.sourceEndpointDefinitions[e], delete this.sourceEndpointDefinitions[e], this.targetEndpointDefinitions[b] = this.targetEndpointDefinitions[e], delete this.targetEndpointDefinitions[e], this.anchorManager.changeId(e, b), this.getDragManager().changeId(e, b), y[b] = y[e], delete y[e];
        ...
        var r = new q;
        b.jsPlumb = r, r.getInstance = function (a) {
            var b = new q(a);
            return b.init(), b
        }, r.each = function (a, b) {
            if (null != a)
        ...
        var b = (!!window.SVGAngle || document.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#BasicStructure", "1.1"), function (a, b) {
            ...
            l = function (a, b, c) {
                ...
                var d = k(a),
                    ...
                    f = function (a, b) {
                        for (var c = 0; c < b.length; c++)
                            if (a) - 1 == e.indexOf(b[c]) && e.push(b[c]);
                            else {
                                var d = e.indexOf(b[c]); - 1 != d && e.splice(d, 1)
                            }
                    };
    ...
    function () {
        ...
        b.OverlayCapableJsPlumbUIComponent = function (a) {
            ...
            removeOverlay: function (a, b) {
                ...
                c && (!b && c.cleanup && c.cleanup(), delete this._jsPlumb.overlays[a], this._jsPlumb.overlayPositions && delete this._jsPlumb.overlayPositions[a])
            },
    ...
    function () {
                ...
                return {
                    drag: function () {
                        ...
                        if (b.element) {
                            ...
                            jsPlumb.setPosition(b.element, e), c.repaint(b.element, e), a.paint({
        ...
        b.Endpoint = function (a) {
            ...
            this.bind("mouseover", function () {
                ...
                var h = null == g ? this.connections.indexOf(a) : g,
                    j = !1;
                ...
                if (!o && b.isDragSupported(this.element)) {
                    var g, h = {
                        ...
                        y = function () {
                            ...
                            var o = this._jsPlumb.instance.getOffset(this.canvas),
                                r = this.canvas,
                                s = this._jsPlumb.instance.getSize(this.canvas);
                            ...
                            if (null == m) this.setHover(!1, !1), m = j({
                                ...
                                scope: a.scope,
                                data: d
                            }), m.pending = !0, m.addClass(i.draggingClass), this._jsPlumb.floatingEndpoint.addClass(i.draggingClass), this._jsPlumb.floatingEndpoint.anchor = w, i.fire("connectionDrag", m), i.anchorManager.newConnection(m);
                            else {
                                n = !0, m.setHover(!1);
                        ...
                        z = function () {
                            if (i.setConnectionBeingDragged(!1), m && null != m.endpoints) {
                                ...
                                this.deleteAfterDragStop ? i.deleteObject({
                                    ...
                                    recalc: !1
                                }), i.fire("connectionDragStop", m, a), m.pending && i.fire("connectionAborted", m, a), i.currentlyDragging = !1, m = null
                            }
    ...
    function () {
        ...
        b.Connectors.AbstractConnector = function (a) {
            ...
            var f = [],
                ...
                r = null,
                s = null,
                t = a.editable !== !1 && null != jsPlumb.ConnectorEditors && null != jsPlumb.ConnectorEditors[this.type],
            ...
            this.hasBeenEdited = function () {
                ...
                return t = a && null != jsPlumb.ConnectorEditors && null != jsPlumb.ConnectorEditors[this.type] && (null == this.overrideSetEditable || this.overrideSetEditable()) ? a : !1
            }, this.isEditable = function () {
                return t
        ...
        h.prototype = {
            ...
            }, this.elementCreated = function (b) {
                if (this.path = b, a.events)
                    for (var c in a.events) jsPlumb.on(b, c, a.events[c])
    ...
    function () {
        ...
        c.extend(z, b.jsPlumbUIComponent, {
            ...
            this.setEditable = function (a) {
                ...
                jsPlumb[b ? "addClass" : "removeClass"](this.canvas, this._jsPlumb.instance.editableConnectorClass)
        ...
        b.extend(a.jsPlumbInstance.prototype, {
            ...
            setPosse: function (a) {
                var b = Array.prototype.slice.call(arguments, 1),
                    c = f(this);
                jsPlumb.each(a, function (a) {
                    a = [jsPlumb.getElement(a)], a.push.apply(a, b), c.setPosse.apply(c, a)
                })
            },
            ...
            setPosseState: function (a, b, c) {
                var d = f(this);
                jsPlumb.each(a, function (a) {
                    d.setPosseState(jsPlumb.getElement(a), b, c)
                })
            },
            dragEvents: {
                start: "start",
